...
const Navbar = () => {
    return <nav className="mb-20 flex items-center justify-between py-6 h-20">
        ...
        <div className="m-8 flex items-center justify-center gap-4 text-2xl">
            <a href="https://www.linkedin.com/in/vyshnavk1/"><FaLinkedin/></a>
            <a href="https://github.com/vyshnavkandamath"><FaGithub/></a>
            <a href="https://www.instagram.com/vyshnavk_"><FaInstagram/></a>
        </div>
